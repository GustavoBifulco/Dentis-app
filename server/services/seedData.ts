...
const DEFAULT_INVENTORY = [
    ...
    { name: 'Alveolótomo', category: 'Cirurgia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Alginato (454g)', category: 'Prótese & Moldagem', quantity: 0, unit: 'un (pacote)', minLevel: 0
    { name: 'Gaze Estéril', category: 'Descartáveis', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Luva Cirúrgica Estéril', category: 'Biossegurança', quantity: 0, unit: 'par', minLevel: 0
    { name: 'Cariostático', category: 'Preventivo', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Anestésico Tópico (Benzocaína)', category: 'Anestesia', quantity: 0, unit: 'Pote', minLevel: 0
    { name: 'Selante Resinoso', category: 'Restaurador', quantity: 0, unit: 'seringa', minLevel: 0
    { name: 'Indicador Biológico (Teste Autoclave)', category: 'Esterilização', quantity: 0, unit: 'Caixa (10un)', minLevel: 0
    { name: 'Broca Diamantada Cilíndrica', category: 'Instrumentais Rotatórios', quantity: 0, unit: 'Unidade', minLevel: 0
    { name: 'Mini-implante Ortodôntico', category: 'Ortodontia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Alginato', category: 'Prótese & Moldagem', quantity: 0, unit: 'Pacote', minLevel: 0
    { name: 'Bráquetes Metálicos (Caso)', category: 'Ortodontia', quantity: 0, unit: 'Cartela', minLevel: 0 },
    { name: 'Fio Dental Profissional', category: 'Profilaxia & Periodontia', quantity: 0, unit: 'm', minLevel: 0
    { name: 'Hipoclorito de Sódio 2.5% e 5%', category: 'Endodontia', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Selante Resinoso', category: 'Restaurador', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Soro Fisiológico 0.9%', category: 'Soluções', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Taça de Borracha / Escova Robson', category: 'Profilaxia & Periodontia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Ácido Fosfórico 37%', category: 'Restaurador', quantity: 0, unit: 'un (seringa)', minLevel: 0
    { name: 'Broca Transmetal', category: 'Instrumentais Rotatórios', quantity: 0, unit: 'Unidade', minLevel: 0
    { name: 'Gás Ozônio (Cilindro O3)', category: 'Equipamentos & Gases', quantity: 0, unit: 'un', minLevel: 0 },
    { name: 'Silicone de Condensação (Kit)', category: 'Prótese & Moldagem', quantity: 0, unit: 'Kit', minLevel: 0
    { name: 'Filme Periapical (Adulto/Infantil)', category: 'Radiologia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Pasta Profilática', category: 'Profilaxia & Periodontia', quantity: 0, unit: 'Bisnaga', minLevel: 0
    { name: 'Máscara N95/PFF2', category: 'Biossegurança', quantity: 0, unit: 'Unidade', minLevel: 0 },
    { name: 'Seringa Insulina', category: 'Descartáveis', quantity: 0, unit: 'unidade', minLevel: 0
    { name: 'Matriz de Poliéster', category: 'Restaurador', quantity: 0, unit: 'Caixa (50un)', minLevel: 0 },
    { name: 'Posicionador Radiográfico', category: 'Radiologia', quantity: 0, unit: 'Kit', minLevel: 0 },
    { name: 'Silano', category: 'Restaurador', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Arcos Ortodônticos (NiTi/Aço)', category: 'Ortodontia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Fio de Sutura Nylon', category: 'Cirurgia', quantity: 0, unit: 'Caixa (24un)', minLevel: 0
    { name: 'Resina Ortodôntica (Transbond)', category: 'Ortodontia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Silano', category: 'Restaurador', quantity: 0, unit: 'Frasco', minLevel: 0
    { name: 'Fita Indicadora de pH Salivar', category: 'Diagnóstico', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Bolinha de Algodão', category: 'Descartáveis', quantity: 0, unit: 'Pacote (500g)', minLevel: 0
    { name: 'Cânulas de Preenchimento (22G/25G)', category: 'HOF', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Toxina Botulínica (50U/100U)', category: 'HOF', quantity: 0, unit: 'Frasco', minLevel: 0
    ...
    { name: 'Silicone de Adição (Kit)', category: 'Prótese & Moldagem', quantity: 0, unit: 'Kit', minLevel: 0
    { name: 'Papel Grau Cirúrgico 10cm', category: 'Esterilização', quantity: 0, unit: 'Rolo', minLevel: 0
    { name: 'Seringas (1/3/5/10/20ml)', category: 'Descartáveis', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Peróxido (Hidrogênio/Carbamida)', category: 'Estética', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Silano', category: 'Restaurador', quantity: 0, unit: 'ml', minLevel: 0 },
    { name: 'Seringa Insulina/Aplicação', category: 'Descartáveis', quantity: 0, unit: 'Pacote', minLevel: 0
    { name: 'Rolete de Algodão', category: 'Descartáveis', quantity: 0, unit: 'unidade', minLevel: 0
    { name: 'Tira de Lixa (Aço/Poliéster)', category: 'Restaurador', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Vaselina Sólida', category: 'Auxiliares', quantity: 0, unit: 'g', minLevel: 0
    { name: 'Luva de Procedimento (PP/P/M/G)', category: 'Biossegurança', quantity: 0, unit: 'par', minLevel: 0
    { name: 'Resina Composta (Esm/Dent/Flow)', category: 'Restaurador', quantity: 0, unit: 'g', minLevel: 0
    { name: 'Dessensibilizante Dentário', category: 'Restaurador', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Silicone Adição / Condensação', category: 'Prótese & Moldagem', quantity: 0, unit: 'ml', minLevel: 0 },
    { name: 'Ácido Deoxicólico (Enzima de Papada)', category: 'HOF', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Silicone de Adição', category: 'Prótese & Moldagem', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Agulha de Irrigação Endo', category: 'Endodontia', quantity: 0, unit: 'Pacote', minLevel: 0
    { name: 'Ácido Hialurônico', category: 'HOF', quantity: 0, unit: 'Seringa', minLevel: 0 },
    { name: 'Esponja Hemostática', category: 'Cirurgia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Flúor Verniz', category: 'Preventivo', quantity: 0, unit: 'Frasco/Dose', minLevel: 0 },
    { name: 'Taça de Borracha', category: 'Profilaxia & Periodontia', quantity: 0, unit: 'Unidade', minLevel: 0 },
    { name: 'Resina Flow A2', category: 'Restaurador', quantity: 0, unit: 'Seringa 2g', minLevel: 0
    { name: 'Soro Fisiológico 0.9% (Bolsa 250ml)', category: 'Soluções', quantity: 0, unit: 'Bolsa', minLevel: 0
    { name: 'Adesivo Universal', category: 'Restaurador', quantity: 0, unit: 'Frasco (5ml)', minLevel: 0
    { name: 'Resina Dentina DA2', category: 'Restaurador', quantity: 0, unit: 'Tubo 4g', minLevel: 0
    { name: 'Placa de Acetato', category: 'Prótese & Moldagem', quantity: 0, unit: 'unidade', minLevel: 0
    { name: 'Pino de Fibra de Vidro (Nº 0.5 a 3)', category: 'Restaurador', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Rolete de Algodão', category: 'Descartáveis', quantity: 0, unit: 'Pacote (100un)', minLevel: 0
    { name: 'Broca Endo-Z', category: 'Instrumentais Rotatórios', quantity: 0, unit: 'Unidade', minLevel: 0
    { name: 'Avental Descartável Manga Longa', category: 'Biossegurança', quantity: 0, unit: 'Pacote (10un)', minLevel: 0
    { name: 'Ácido Fosfórico 37%', category: 'Restaurador', quantity: 0, unit: 'Kit (3 seringas)', minLevel: 0
    { name: 'Sugador Descartável (Convencional)', category: 'Descartáveis', quantity: 0, unit: 'Pacote (40un)', minLevel: 0
    { name: 'Resina Acrílica (Duralay)', category: 'Prótese & Moldagem', quantity: 0, unit: 'grama', minLevel: 0
    { name: 'Óculos de Proteção', category: 'Biossegurança', quantity: 0, unit: 'Unidade', minLevel: 0
    { name: 'Resina Esmalte', category: 'Restaurador', quantity: 0, unit: 'grama', minLevel: 0
    { name: 'Cone de Papel', category: 'Endodontia', quantity: 0, unit: 'Caixa', minLevel: 0
    { name: 'Taça de Borracha', category: 'Profilaxia & Periodontia', quantity: 0, unit: 'unidade', minLevel: 0
    { name: 'Copo Descartável', category: 'Descartáveis', quantity: 0, unit: 'Pacote (100un)', minLevel: 0 },
    { name: 'Fio/Arco NiTi', category: 'Ortodontia', quantity: 0, unit: 'Pacote', minLevel: 0
    { name: 'Membrana Colágeno', category: 'Cirurgia', quantity: 0, unit: 'Unidade', minLevel: 0
    { name: 'Tira de Lixa de Aço', category: 'Restaurador', quantity: 0, unit: 'unidade', minLevel: 0
    { name: 'Anestésico Articaína 4%', category: 'Anestesia', quantity: 0, unit: 'Caixa (50 tubetes)', minLevel: 0
    { name: 'Bioestimulador de Colágeno', category: 'HOF', quantity: 0, unit: 'un (frasco)', minLevel: 0
    { name: 'Seringa Carpule', category: 'Anestesia', quantity: 0, unit: 'unidade', minLevel: 0
    { name: 'Torno Expansor', category: 'Ortodontia', quantity: 0, unit: 'unidade', minLevel: 0
    { name: 'Enxerto Ósseo Bovino', category: 'Cirurgia', quantity: 0, unit: 'Frasco', minLevel: 0 },
    { name: 'Matriz Metálica / Poliéster', category: 'Restaurador', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Fio/Arco Aço', category: 'Ortodontia', quantity: 0, unit: 'Pacote', minLevel: 0
    { name: 'Lâmina de Bisturi (11/12/15/15C)', category: 'Cirurgia', quantity: 0, unit: 'un', minLevel: 0
    { name: 'Detergente Enzimático 5 Enzimas', category: 'Esterilização', quantity: 0, unit: 'Galão (5L)', minLevel: 0 },
    { name: 'Clorexidina (0,12% / 2%)', category: 'Profilaxia & Periodontia', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Limas (Manual/Rotatória/Reciproc.)', category: 'Endodontia', quantity: 0, unit: 'un', minLevel: 0 },
    { name: 'Líquido Fixador', category: 'Radiologia', quantity: 0, unit: 'Frasco', minLevel: 0 },
    { name: 'Verniz Fluoretado', category: 'Preventivo', quantity: 0, unit: 'ml', minLevel: 0
    { name: 'Hipoclorito de Sódio 2.5%', category: 'Endodontia', quantity: 0, unit: 'Frasco (1L)', minLevel: 0 },
    { name: 'Formocresol', category: 'Endodontia', quantity: 0, unit: 'ml', minLevel: 0 },
    { name: 'Cimento Endodôntico (Ah Plus/Eugenol)', category: 'Endodontia', quantity: 0, unit: 'Kit', minLevel: 0 },
    { name: 'Cimento Ionômero de Vidro (Cimentação)', category: 'Restaurador', quantity: 0, unit: 'Kit', minLevel: 0 },
    { name: 'Sugador (Convenc./Cirúrgico)', category: 'Descartáveis', quantity: 0, unit: 'un', minLevel: 0 },
    { name: 'Água Destilada', category: 'Soluções', quantity: 0, unit: 'ml', minLevel: 0 },
];
